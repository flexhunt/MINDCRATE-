...
DROP FUNCTION IF EXISTS get_chat_context(INTEGER);

-- Remove old Angle profile and policies
DELETE FROM profiles WHERE id = '00000000-0000-0000-0000-000000000001';
DROP POLICY IF EXISTS "Allow Angle AI to insert messages" ON global_chat_messages;
DROP POLICY IF EXISTS "Allow Angle AI to select messages" ON global_chat_messages;
